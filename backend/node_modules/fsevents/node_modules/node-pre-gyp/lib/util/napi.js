...
module.exports.validate_package_json = function(package_json, opts) {
  ...
  var napi_build_versions = module.exports.get_napi_build_versions(
    package_json,
    opts,
    true
  );
  var napi_build_versions_raw = module.exports.get_napi_build_versions_raw(
    package_json
  );
  ...
  if (
    ...
    throw new Error(
      "The N-API version of this Node instance is " +
        module.exports.get_napi_version(opts ? opts.target : undefined) +
        ". " +
        "This module supports N-API version(s) " +
...
module.exports.expand_commands = function(package_json, opts, commands) {
  ...
  commands.forEach(function(command) {
    if (napi_build_versions && command.name === "install") {
      var napi_build_version = module.exports.get_best_napi_build_version(
        package_json,
        opts
      );
...
module.exports.get_napi_build_versions = function(
  ...
  var supported_napi_version = module.exports.get_napi_version(
  ...
  if (package_json.binary && package_json.binary.napi_versions) {
    package_json.binary.napi_versions.forEach(function(napi_version) {
      ...
      if (
        ...
        log.info(
          "This Node instance does not support builds for N-API version",
          napi_version
        );
      }
    });
