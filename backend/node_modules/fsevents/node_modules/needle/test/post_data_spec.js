    ...
    describe("when object", function() {
      describe("get request", function() {
        it("sends request", function(done) {
          ...
          get({ foo: "bar", test: "测试" }, { multipart: true }, function(
            err,
            resp
          ) {
            check_request("get");
        ...
        it("sets Content-Type header", function(done) {
          post({ foo: "bar", test: "测试" }, { multipart: true }, function(
            err,
            resp
          ) {
            resp.body.headers["content-type"].should.equal(
              "multipart/form-data; boundary=--------------------NODENEEDLEHTTPCLIENT"
            );
            done();
          });
        });
        ...
        it("writes japanese chars correctly as binary", function(done) {
          ...
          get({ foo: "bar", test: "测试" }, { multipart: true }, function(
            ...
            spy.args[0][0].should.be.an.instanceof(String);
            Buffer.from(spy.args[0][0])
              .toString("hex")
              .should.eql(
                ""
              );
            done();
          });
        });
      ...
      describe("get request", function() {
        describe("with json: false (default)", function() {
          it("sends request, adding data as querystring", function(done) {
            ...
            get({ foo: "bar", test: "测试" }, { json: false }, function(
              err,
              resp
            ) {
              check_request("get");
              stub.args[0][0]["path"].should.equal(
                "/?foo=bar&test=%E6%B5%8B%E8%AF%95"
              );
              done();
            });
          });
        ...
        describe("with json: true", function() {
          it("sends request, without setting a querystring", function(done) {
            ...
            get({ foo: "bar", test: "测试" }, { json: true }, function(
              err,
              resp
            ) {
              check_request("get");
      ...
      describe("post request", function() {
        describe("with json: false (default)", function() {
          it("sends request", function(done) {
            ...
            post({ foo: "bar", test: "测试" }, { json: false }, function(
              err,
              resp
            ) {
              check_request("post");
          ...
          it("writes as buffer", function(done) {
            post({ foo: "bar", test: "测试" }, { json: false }, function(
              ...
              spy.args[0][0]
                .toString()
                .should.equal("foo=bar&test=%E6%B5%8B%E8%AF%95");
        ...
        describe("with json: true", function() {
          it("sends request", function(done) {
            ...
            post({ foo: "bar", test: "测试" }, { json: true }, function(
              err,
              resp
            ) {
              check_request("post");
