...
helpers.server = function(opts, cb) {
  ...
  var get = function(what) {
    if (!opts[what]) return defaults[what];

    if (typeof opts[what] == "function") return opts[what]();
    // set them at runtime
    else return opts[what];
  };
  ...
  else server = protocols[protocol].createServer(handler);
