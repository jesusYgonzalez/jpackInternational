...
describe("cookies", function() {
  ...
  describe("with default options", function() {
    it("no cookie header is set on request", function(done) {
      needle.get(TEST_HOST + ":" + ALL_COOKIES_TEST_PORT, function(
        err,
        response
      ) {
  ...
  describe("if response does not contain cookies", function() {
    ...
    it("response.cookies is undefined", function(done) {
      needle.get(TEST_HOST + ":" + NO_COOKIES_TEST_PORT, function(
        error,
        response
      ) {
  ...
  describe("if response contains cookies", function() {
    ...
    describe("when a cookie value is invalid", function() {
      ...
      it("doesnt blow up", function(done) {
        needle.get(TEST_HOST + ":" + ALL_COOKIES_TEST_PORT, function(
          ...
          var whatever =
            "efbfbdefbfbdefbfbdefbfbdefbfbd2defbfbdefbfbdefbfbdefbfbdefbfbdefbfbdefbfbdefbfbdefbfbd";
          Buffer.from(response.cookies.geo_city)
            .toString("hex")
            .should.eql(whatever);
          done();
        });
    ...
    describe("and response is a redirect", function() {
      ...
      before(function() {
        redirectServer = http
          .createServer(function(req, res) {
            ...
            var nextUrl =
              "http://" + TEST_HOST + ":" + testPort + "/" + (number + 1);

            if (responseCookies[number]) {
              // got cookies
              res.statusCode = 302;
      ...
      describe("and follow_set_cookies is false", function() {
        ...
        it("no cookie header set on redirection request", function(done) {
          ...
          needle.get(TEST_HOST + ":" + testPort + "/0", opts, function(
            err,
            resp
          ) {
    ...
    describe("with parse_cookies = false", function() {
      it("does not parse them", function(done) {
        needle.get(
          TEST_HOST + ":" + ALL_COOKIES_TEST_PORT,
          { parse_cookies: false },
  ...
  describe("if request contains cookie header", function() {
    ...
    it("must be a valid cookie string", function(done) {
      ...
      needle.get(TEST_HOST + ":" + ALL_COOKIES_TEST_PORT, opts, function(
        error,
        response
      ) {
