...
var tls_options =
  "agent pfx key passphrase cert ca ciphers rejectUnauthorized secureProtocol checkServerIdentity";
...
Needle.prototype.setup = function(uri, options) {
  ...
  var config = {
    ...
    encoding:
      options.encoding || (options.multipart ? "binary" : defaults.encoding)
  };
...
Needle.prototype.send_request = function(
  ...
  var request = protocol.request(request_opts, function(resp) {
    ...
    if (
      ...
      (headers["set-cookie"] || config.stored_cookies)
    ) {
      resp.cookies = extend(
        config.stored_cookies || {},
    ...
    if (
      ...
      if (count <= config.follow_max) {
        ...
        return self.send_request(
          ++count,
          method,
          url.resolve(uri, headers.location),
          config,
          post_data,
          out,
          callback
    ...
    if (config.parser && parsers[mime.type]) {
      ...
      text_response &&
      config.decode_response &&
      mime.charset &&
      !mime.charset.match(/utf-?8$/i)
    ) {
...
if (typeof Promise !== "undefined") {
  module.exports = function() {
    ...
    return new Promise(function(resolve, reject) {
      module.exports.request(verb, args[0], args[1], args[2], function(
        err,
        resp
      ) {
