...
const npmWalker = Class =>
  class Walker extends Class {
    ...
    filterEntry(entry, partial) {
      ...
      const pkg =
        isRoot && pkgre.test(entry) ? entry.replace(pkgre, "$1") : null;
    ...
    addIgnoreFile(file, then) {
      ...
      else super.addIgnoreFile(file, then);
    }
    ...
    onstat(st, entry, file, dir, then) {
      if (st.isSymbolicLink()) then();
      else super.onstat(st, entry, file, dir, then);
    }
