...
const getDiscriminatorByValue = require("./queryhelpers")
...
Model.prototype.$__save = function(options, callback) {
  this.$__handleSave(options, (error, result) => {
    if (error) {
      return this.schema.s.hooks.execPost(
        "save:error",
        this,
        [this],
        { error: error },
...
function checkDivergentArray(doc, path, array) {
  ...
  const check =
    pop.options.match ||
    (pop.options.options &&
      utils.object.hasOwnProperty(pop.options.options, "limit")) || // 0 is not permitted
...
Model.estimatedDocumentCount = function estimatedDocumentCount(
  options,
  callback
) {
  // get the mongodb collection object
...
Model.findByIdAndUpdate = function(id, update, options, callback) {
  ...
  return this.findOneAndUpdate.call(
    this,
    { _id: id },
    update,
    options,
...
Model.geoSearch = function(conditions, options, callback) {
  ...
  return utils.promiseOrCallback(
    ...
    cb => {
      ...
      this.collection.geoHaystackSearch(
        options.near[0],
        options.near[1],
        options,
        (err, res) => {
...
function getModelsMapForPopulate(model, docs, options) {
  ...
  for (i = 0; i < len; i++) {
    ...
    let foreignField =
      virtual && virtual.options ? virtual.options.foreignField : "_id";
  ...
  if (typeof name === "function" && name.prototype instanceof Model) {
    ...
    model = function model(doc, fields, skipId) {
      ...
      if (
        ...
        return new model.discriminators[doc[discriminatorKey]](
          doc,
          fields,
          skipId
        );
...
Model.__subclass = function subclass(conn, schema, collection) {
  ...
  const s =
    schema && typeof schema !== "string" ? schema : _this.prototype.schema;
