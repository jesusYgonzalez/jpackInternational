...
EmbeddedDocument.prototype.populate = function() {
  throw new Error(
    "Mongoose does not support calling populate() on nested " +
...
EmbeddedDocument.prototype.save = function(options, fn) {
  ...
  if (!options.suppressWarning) {
    console.warn(
      "mongoose: calling `save()` on a subdoc does **not** save " +
...
EmbeddedDocument.prototype.remove = function(options, fn) {
  ...
  if (!this.willRemove) {
    ...
    if (!_id) {
      throw new Error(
        "For your own good, Mongoose does not know " +
...
if (util.inspect.custom) {
  ...
  EmbeddedDocument.prototype[util.inspect.custom] =
    EmbeddedDocument.prototype.inspect;
}
...
EmbeddedDocument.prototype.$isValid = function(path) {
  ...
  if (typeof index !== "undefined" && this[documentArrayParent]) {
    return (
      !this[documentArrayParent].$__.validationError ||
      !this[documentArrayParent].$__.validationError.errors[
