...
function SchemaType(path, options, instance) {
  ...
  this.validators =
    options != null && Array.isArray(options.validators)
...
SchemaType.prototype.validate = function(obj, message, type) {
  if (
    typeof obj === "function" ||
    (obj && utils.getFunctionName(obj.constructor) === "RegExp")
  ) {
    let properties;
...
SchemaType.prototype.applySetters = function(
  value,
  scope,
  init,
  priorVal,
  ...
  const validate = function(ok, validatorProperties) {
    ...
    if (ok === undefined || ok) {
      ...
      const ErrorConstructor =
        validatorProperties.ErrorConstructor || ValidatorError;
