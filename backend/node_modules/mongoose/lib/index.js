...
if (global.MONGOOSE_DRIVER_PATH) {
  const deprecationWarning =
    "The `MONGOOSE_DRIVER_PATH` global property is " +
 ...
 *
 * @param {{AntiStaticBags, PolyBagSealer, PolypropyleneBags, ClearPolyBags, BubblePouches}} name model name or class extending Model
