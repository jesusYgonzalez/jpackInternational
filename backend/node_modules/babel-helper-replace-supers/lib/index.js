...
var ReplaceSupers = (function() {
  ...
  ReplaceSupers.prototype.setSuperProperty = function setSuperProperty(
    property,
    value,
    isComputed
  ) {
  ...
  ReplaceSupers.prototype.getSuperProperty = function getSuperProperty(
    property,
    isComputed
  ) {
  ...
  ReplaceSupers.prototype.getLooseSuperProperty = function getLooseSuperProperty(
    id,
    parent
  ) {
  ...
  ReplaceSupers.prototype.specHandleAssignmentExpression = function specHandleAssignmentExpression(
    ref,
    path,
    node
  ) {
  ...
  ReplaceSupers.prototype.optimiseCall = function optimiseCall(callee, args) {
    ...
    return (0, _babelHelperOptimiseCallExpression2.default)(
      callee,
      thisNode,
      args
    );
