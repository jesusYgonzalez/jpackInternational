...
var _babelHelperReplaceSupers2 = _interopRequireDefault(
  _babelHelperReplaceSupers
);

var _babelHelperOptimiseCallExpression = require("babel-helper-optimise-call-expression");

var _babelHelperOptimiseCallExpression2 = _interopRequireDefault(
  _babelHelperOptimiseCallExpression
);
...
var verifyConstructorVisitor = _babelTraverse.visitors.merge([
  noMethodVisitor,
  {
...
var findThisesVisitor = _babelTraverse.visitors.merge([
  noMethodVisitor,
  {
    ThisExpression: function ThisExpression(path) {
...
var ClassTransformer = (function() {
  ...
  ClassTransformer.prototype.run = function run() {
    ...
    body = body.concat(
      this.staticPropBody.map(function(fn) {
  ...
  ClassTransformer.prototype.buildObjectAssignment = function buildObjectAssignment(
    id
  ) {
  ...
  ClassTransformer.prototype.wrapSuperCall = function wrapSuperCall(
    bareSuper,
    superRef,
    thisRef,
    body
    ...
    if (this.isLoose) {
      ...
      bareSuperNode = (0, _babelHelperOptimiseCallExpression2.default)(
        t.logicalExpression(
          "||",
    ...
    if (
      ...
      bareSuper.replaceWithMultiple(
        ...
        ].concat(bareSuperAfter, [t.expressionStatement(thisRef)])
      );
    }
  };
  ...
  ClassTransformer.prototype.verifyConstructor = function verifyConstructor() {
    ...
    for (
      var _iterator3 = this.bareSupers,
    ...
    for (
      var _iterator4 = this.superThises,
    ...
    var wrapReturn = function wrapReturn(returnArg) {
      return t.callExpression(
        _this2.file.addHelper("possibleConstructorReturn"),
    ...
    for (
      var _iterator5 = this.superReturns,
  ...
  ClassTransformer.prototype.pushInherits = function pushInherits() {
    ...
    this.body.unshift(
      t.expressionStatement(
        t.callExpression(this.file.addHelper("inherits"), [
          this.classRef,
          this.superName
        ])
      )
