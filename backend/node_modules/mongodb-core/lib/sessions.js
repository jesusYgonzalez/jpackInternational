...
class ClientSession extends EventEmitter {
  ...
  constructor(topology, sessionPool, options, clientOptions) {
    ...
    this.supports = {
      causalConsistency:
        typeof options.causalConsistency !== "undefined"
          ? options.causalConsistency
          : true
    };
  ...
  startTransaction(options) {
    ...
    this.transaction = new Transaction(
      Object.assign(
        {},
        this.clientOptions,
        options || this.defaultTransactionOptions
      )
    );
...
function applySession(session, command, options) {
  ...
  const inTransaction =
    session.inTransaction() || isTransactionCommand(command);
