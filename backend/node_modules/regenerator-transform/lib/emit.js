...
Ep.explode = function(path, ignoreResult) {
  ...
  switch (node.type) {
    ...
    default:
      throw new Error(
        "unknown Node of type " + (0, _stringify2.default)(node.type)
      );
  }
};
...
Ep.explodeStatement = function(path, labelId) {
  ...
  switch (stmt.type) {
    ...
    default:
      throw new Error(
        "unknown Statement of type " + (0, _stringify2.default)(stmt.type)
      );
  }
};
...
Ep.emitAbruptCompletion = function(record) {
  if (!isValidCompletion(record)) {
    _assert2.default.ok(
      false,
      "invalid completion record: " + (0, _stringify2.default)(record)
    );
  }
...
Ep.explodeExpression = function(path, ignoreResult) {
  ...
  switch (expr.type) {
    ...
    default:
      throw new Error(
        "unknown Expression of type " + (0, _stringify2.default)(expr.type)
      );
  }
};
