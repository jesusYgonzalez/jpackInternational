...
exports.default = function(opts) {
  ...
  visitor.ExpressionStatement = function(path, file) {
    ...
    var nodes = [];
    var exploded = (0, _babelHelperExplodeAssignableExpression2.default)(
      expr.left,
      nodes,
      file,
      path.scope,
...
var _babelHelperExplodeAssignableExpression2 = _interopRequireDefault(
  _babelHelperExplodeAssignableExpression
);
