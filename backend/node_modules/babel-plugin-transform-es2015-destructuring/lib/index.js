...
exports.default = function(_ref) {
  ...
  function hasRest(pattern) {
    for (
      var _iterator2 = pattern.elements,
  ...
  var DestructuringTransformer = (function() {
    ...
    DestructuringTransformer.prototype.buildVariableAssignment = function buildVariableAssignment(
      id,
      init
    ) {
    ...
    DestructuringTransformer.prototype.buildVariableDeclaration = function buildVariableDeclaration(
      id,
      init
    ) {
    ...
    DestructuringTransformer.prototype.pushAssignmentPattern = function pushAssignmentPattern(
      pattern,
      valueRef
    ) {
    ...
    DestructuringTransformer.prototype.pushObjectRest = function pushObjectRest(
      pattern,
      objRef,
      spreadProp,
      spreadPropIndex
    ...
    DestructuringTransformer.prototype.pushObjectProperty = function pushObjectProperty(
      prop,
      propRef
    ) {
    ...
    DestructuringTransformer.prototype.pushObjectPattern = function pushObjectPattern(
      pattern,
      objRef
    ) {
    ...
    DestructuringTransformer.prototype.canUnpackArrayPattern = function canUnpackArrayPattern(
      pattern,
      arr
    ) {
      ...
      for (
        var _iterator3 = pattern.elements,
    ...
    DestructuringTransformer.prototype.pushUnpackedArrayPattern = function pushUnpackedArrayPattern(
      pattern,
      arr
    ) {
    ...
    DestructuringTransformer.prototype.pushArrayPattern = function pushArrayPattern(
      pattern,
      arrayRef
    ) {
      ...
      VariableDeclaration: function VariableDeclaration(path, file) {
        ...
        for (
          ...
          if (
            ...
            t.isVariableDeclaration(_node) &&
            tail.kind === _node.kind
          ) {
        ...
        for (
          ...
          for (
            var _iterator7 = nodeOut.declarations,
