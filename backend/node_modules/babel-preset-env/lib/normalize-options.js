...
var validateIncludesAndExcludes = (exports.validateIncludesAndExcludes = function validateIncludesAndExcludes() {
  ...
  (0, _invariant2.default)(
    ...
    "Invalid Option: The '" +
      type +
      "' option must be an Array<String> of plugins/built-ins"
  );
...
var normalizePluginName = (exports.normalizePluginName = function normalizePluginName(
  plugin
) {
  return plugin.replace(/^babel-plugin-/, "");
});

var normalizePluginNames = (exports.normalizePluginNames = function normalizePluginNames(
  plugins
) {
...
var validateBoolOption = (exports.validateBoolOption = function validateBoolOption(
  name,
  value,
  defaultValue
) {
...
var validateSpecOption = (exports.validateSpecOption = function validateSpecOption(
  specOpt
) {
...
var validateModulesOption = (exports.validateModulesOption = function validateModulesOption() {
  ...
  (0, _invariant2.default)(
    modulesOpt === false ||
      Object.keys(_moduleTransformations2.default).indexOf(modulesOpt) > -1,
