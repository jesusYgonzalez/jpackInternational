...
Cursor.prototype._initImplicitSession = function() {
  if (
    ...
    !this.s.session &&
    this.s.topology.hasSessionSupport()
  ) {
...
Cursor.prototype._endSession = function() {
  const didCloseCursor = CoreCursor.prototype._endSession.apply(
    this,
    arguments
  );
  if (didCloseCursor) {
...
Cursor.prototype.setReadPreference = function(readPreference) {
  if (this.s.state !== Cursor.INIT) {
    throw MongoError.create({
      message:
        "cannot change cursor readPreference after cursor has been accessed",
      driver: true
    });
  }
...
Cursor.prototype.count = function(applySkipLimit, opts, callback) {
  ...
  return executeOperation(
    this.s.topology,
    count,
    [this, applySkipLimit, opts, callback],
    {
...
Cursor.prototype._read = function() {
  ...
  this.next((err, result) => {
    ...
    if (
      typeof this.s.streamOptions.transform === "function" &&
      result != null
    ) {
