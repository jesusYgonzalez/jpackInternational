...
class ReplSet extends TopologyBase {
  constructor(servers, options) {
    ...
    var clonedOptions = mergeOptions(
      {},
      {
        ...
        reconnect: false,
        emitError:
          typeof options.emitError === "boolean" ? options.emitError : true,
        size: typeof options.poolSize === "number" ? options.poolSize : 5,
        monitorCommands:
          typeof options.monitorCommands === "boolean"
  ...
  connect(_options, callback) {
    ...
    self.s.storeOptions.bufferMaxEntries =
      typeof _options.bufferMaxEntries === "number"
        ? _options.bufferMaxEntries
        : -1;
    ...
    self.s.coreTopology.on(
      "serverDescriptionChanged",
      relay("serverDescriptionChanged")
    );
    self.s.coreTopology.on(
      "serverHeartbeatStarted",
      relay("serverHeartbeatStarted")
    );
    self.s.coreTopology.on(
      "serverHeartbeatSucceeded",
      relay("serverHeartbeatSucceeded")
    );
    self.s.coreTopology.on(
      "serverHeartbeatFailed",
      relay("serverHeartbeatFailed")
    );
    ...
    self.s.coreTopology.on(
      "topologyDescriptionChanged",
      relay("topologyDescriptionChanged")
    );
  ...
  close(forceClosed, callback) {
    ["timeout", "error", "close", "joined", "left"].forEach(e =>
