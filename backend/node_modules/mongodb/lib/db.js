...
const mergeOptionsAndWriteConcern = require("./utils")
...
const executeDbAdminCommand = require("./operations/db_ops")
  .executeDbAdminCommand;
const indexInformation = require("./operations/db_ops").indexInformation;
const listCollectionsTransforms = require("./operations/db_ops")
...
const validateDatabaseName = require("./operations/db_ops")
...
function Db(databaseName, topology, options) {
  ...
  this.s = {
    ...
    bufferMaxEntries:
      typeof options.bufferMaxEntries === "number"
    ...
    // No listener
    noListener:
      typeof options.noListener === "boolean" ? options.noListener : false,
    // ReadConcern
...
Db.prototype.command = function(command, options, callback) {
  ...
  return executeOperation(this.s.topology, executeCommand, [
    this,
    command,
    options,
    callback
...
Db.prototype.collection = function(name, options, callback) {
  ...
  options = mergeOptionsAndWriteConcern(
    options,
    this.s.options,
    collectionKeys,
    true
  ...
  // Strict mode
  this.listCollections({ name: name }, listCollectionOptions).toArray(
    (err, collections) => {
      ...
      if (collections.length === 0)
        return handleCallback(
          callback,
          toError(
            `Collection ${name} does not exist. Currently in strict mode.`
          ),
          null
        );
...
Db.prototype.createCollection = deprecateOptions(
  ...
  function(name, options, callback) {
    ...
    return executeOperation(this.s.topology, createCollection, [
      this,
      name,
      options,
      callback
...
Db.prototype.listCollections = function(filter, options) {
  ...
  if (this.serverConfig.capabilities().hasListCollectionsCommand) {
    const nameOnly =
      typeof options.nameOnly === "boolean" ? options.nameOnly : false;
    // Build the command
  ...
  // Get the cursor
  cursor = this.collection(CONSTANTS.SYSTEM_NAMESPACE_COLLECTION).find(
    filter,
    _options
  );
  // Do we have a readPreference, apply it
...
Db.prototype.eval = deprecate(function(code, parameters, options, callback) {
  ...
  return executeOperation(this.s.topology, evaluate, [
    this,
    code,
    parameters,
    options,
 ...
 * @return {Promise} returns Promise if no callback passed
 */
Db.prototype.renameCollection = function(
  fromCollection,
  toCollection,
  options,
  callback
...
Db.prototype.dropCollection = function(name, options, callback) {
  ...
  // options
  const opts = Object.assign({}, this.s.options, {
    readPreference: ReadPreference.PRIMARY
  });
  if (options.session) opts.session = options.session;

  return executeOperation(this.s.topology, dropCollection, [
    this,
    cmd,
    opts,
    callback
...
Db.prototype.dropDatabase = function(options, callback) {
  ...
  return executeOperation(this.s.topology, dropDatabase, [
    this,
    cmd,
    finalOptions,
    callback
...
Db.prototype.collections = function(options, callback) {
  ...
  return executeOperation(this.s.topology, collections, [
    this,
    options,
    callback
  ]);
...
Db.prototype.addUser = function(username, password, options, callback) {
  ...
  return executeOperation(this.s.topology, addUser, [
    this,
    username,
    password,
    options,
...
Db.prototype.removeUser = function(username, options, callback) {
  ...
  return executeOperation(this.s.topology, removeUser, [
    this,
    username,
    options,
    callback
...
Db.prototype.setProfilingLevel = function(level, options, callback) {
  ...
  return executeOperation(this.s.topology, setProfilingLevel, [
    this,
    level,
    options,
    callback
...
Db.prototype.profilingInfo = deprecate(function(options, callback) {
  ...
  return executeOperation(this.s.topology, profilingInfo, [
    this,
    options,
    callback
  ]);
...
Db.prototype.profilingLevel = function(options, callback) {
  ...
  return executeOperation(this.s.topology, profilingLevel, [
    this,
    options,
    callback
  ]);
