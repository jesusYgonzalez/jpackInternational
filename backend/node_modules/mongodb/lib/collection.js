...
const checkForAtomicOperators = require("./operations/collection_ops")
...
const findOneAndDelete = require("./operations/collection_ops")
  .findOneAndDelete;
const findOneAndReplace = require("./operations/collection_ops")
  .findOneAndReplace;
const findOneAndUpdate = require("./operations/collection_ops")
  .findOneAndUpdate;
const geoHaystackSearch = require("./operations/collection_ops")
  .geoHaystackSearch;
...
const indexInformation = require("./operations/collection_ops")
  .indexInformation;
...
const parallelCollectionScan = require("./operations/collection_ops")
...
function Collection(db, topology, dbName, name, pkFactory, options) {
  ...
  const slaveOk =
    options == null || options.slaveOk == null ? db.slaveOk : options.slaveOk;
  const serializeFunctions =
    options == null || options.serializeFunctions == null
      ? db.s.options.serializeFunctions
      : options.serializeFunctions;
  const raw =
    options == null || options.raw == null ? db.s.options.raw : options.raw;
  const promoteLongs =
...
Collection.prototype.find = deprecateOptions(
  ...
  function(query, options, callback) {
    ...
    if (Buffer.isBuffer(object)) {
      const object_size =
        object[0] | (object[1] << 8) | (object[2] << 16) | (object[3] << 24);
    ...
    newOptions.raw =
      typeof options.raw === "boolean" ? options.raw : this.s.raw;
    newOptions.hint =
      options.hint != null
        ? normalizeHintField(options.hint)
        : this.s.collectionHint;
    newOptions.timeout =
      typeof options.timeout === "undefined" ? undefined : options.timeout;
    // // If we have overridden slaveOk otherwise use the default db setting
    newOptions.slaveOk =
      options.slaveOk != null ? options.slaveOk : this.s.db.slaveOk;
    ...
    if (
      ...
      (newOptions.readPreference !== "primary" ||
        newOptions.readPreference.mode !== "primary")
    ) {
    ...
    if (
      newOptions.promoteLongs == null &&
      typeof this.s.promoteLongs === "boolean"
    )
      newOptions.promoteLongs = this.s.promoteLongs;
    if (
      newOptions.promoteValues == null &&
      typeof this.s.promoteValues === "boolean"
    )
      newOptions.promoteValues = this.s.promoteValues;
    if (
      newOptions.promoteBuffers == null &&
      typeof this.s.promoteBuffers === "boolean"
    )
    ...
    return typeof callback === "function"
      ? handleCallback(callback, null, cursor)
      : cursor;
  }
);
...
Collection.prototype.insertOne = function(doc, options, callback) {
  ...
  return executeOperation(this.s.topology, insertOne, [
    this,
    doc,
    options,
    callback
...
Collection.prototype.insertMany = function(docs, options, callback) {
  ...
  return executeOperation(this.s.topology, insertMany, [
    this,
    docs,
    options,
    callback
...
Collection.prototype.bulkWrite = function(operations, options, callback) {
  ...
  return executeOperation(this.s.topology, bulkWrite, [
    this,
    operations,
    options,
    callback
...
Collection.prototype.updateOne = function(filter, update, options, callback) {
  ...
  return executeOperation(this.s.topology, updateOne, [
    this,
    filter,
    update,
    options,
...
Collection.prototype.replaceOne = function(filter, doc, options, callback) {
  ...
  return executeOperation(this.s.topology, replaceOne, [
    this,
    filter,
    doc,
    options,
...
Collection.prototype.updateMany = function(filter, update, options, callback) {
  ...
  return executeOperation(this.s.topology, updateMany, [
    this,
    filter,
    update,
    options,
...
Collection.prototype.deleteOne = function(filter, options, callback) {
  ...
  return executeOperation(this.s.topology, deleteOne, [
    this,
    filter,
    options,
    callback
...
Collection.prototype.deleteMany = function(filter, options, callback) {
  ...
  return executeOperation(this.s.topology, deleteMany, [
    this,
    filter,
    options,
    callback
...
Collection.prototype.remove = deprecate(function(selector, options, callback) {
  ...
  return executeOperation(this.s.topology, removeDocuments, [
    this,
    selector,
    options,
    callback
...
Collection.prototype.save = deprecate(function(doc, options, callback) {
  ...
  return executeOperation(this.s.topology, save, [
    this,
    doc,
    options,
    callback
...
Collection.prototype.findOne = deprecateOptions(
  ...
  function(query, options, callback) {
    ...
    return executeOperation(this.s.topology, findOne, [
      this,
      query,
      options,
      callback
...
Collection.prototype.drop = function(options, callback) {
  ...
  return executeOperation(
    this.s.topology,
    this.s.db.dropCollection.bind(this.s.db),
    [this.s.name, options, callback]
  );
};
...
Collection.prototype.createIndexes = function(indexSpecs, options, callback) {
  ...
  return executeOperation(this.s.topology, createIndexes, [
    this,
    indexSpecs,
    options,
    callback
...
Collection.prototype.dropIndex = function(indexName, options, callback) {
  ...
  return executeOperation(this.s.topology, dropIndex, [
    this,
    indexName,
    options,
    callback
...
Collection.prototype.dropIndexes = function(options, callback) {
  ...
  return executeOperation(this.s.topology, dropIndexes, [
    this,
    options,
    callback
  ]);
...
Collection.prototype.listIndexes = function(options) {
  ...
  cursor = this.s.topology.cursor(
    ns,
    { find: ns, query: { ns: this.s.namespace } },
    options
  );
  // Do we have a readPreference, apply it
...
Collection.prototype.indexExists = function(indexes, options, callback) {
  ...
  return executeOperation(this.s.topology, indexExists, [
    this,
    indexes,
    options,
    callback
...
Collection.prototype.indexInformation = function(options, callback) {
  ...
  return executeOperation(this.s.topology, indexInformation, [
    this,
    options,
    callback
  ]);
...
Collection.prototype.count = deprecate(function(query, options, callback) {
  ...
  return executeOperation(this.s.topology, count, [
    this,
    query,
    options,
    callback
...
Collection.prototype.countDocuments = function(query, options, callback) {
  ...
  return executeOperation(this.s.topology, countDocuments, [
    this,
    query,
    options,
    callback
...
Collection.prototype.findOneAndDelete = function(filter, options, callback) {
  ...
  return executeOperation(this.s.topology, findOneAndDelete, [
    this,
    filter,
    options,
    callback
 ...
 */
Collection.prototype.findAndModify = deprecate(function(
  query,
  sort,
  doc,
  options,
...
Collection.prototype.findAndRemove = deprecate(function(
  ...
  return executeOperation(this.s.topology, findAndRemove, [
    this,
    query,
    sort,
    options,
...
Collection.prototype.geoHaystackSearch = function(x, y, options, callback) {
  ...
  return executeOperation(this.s.topology, geoHaystackSearch, [
    this,
    x,
    y,
    options,
...
Collection.prototype.mapReduce = function(map, reduce, options, callback) {
  ...
  return executeOperation(this.s.topology, mapReduce, [
    this,
    map,
    reduce,
    options,
