...
describe("sourceMappingURL", function() {
  describe(".getFrom", function() {
    forEachComment(function(comment, description) {
      it("gets the url from " + description, function() {
        ...
        expect(sourceMappingURL.getFrom("code" + comment)).to.equal(
          "foo.js.map"
        );
    ...
    forEachNonTrailingComment(function(comment, description) {
      it("gets the url from " + description, function() {
        expect(sourceMappingURL.getFrom("code\n" + comment.contents)).to.equal(
          "foo.js.map"
        );

        expect(sourceMappingURL.getFrom("code" + comment.contents)).to.equal(
          "foo.js.map"
        );

        expect(sourceMappingURL.getFrom(comment.contents)).to.equal(
          "foo.js.map"
        );
      });
    });
  ...
  describe(".existsIn", function() {
    ...
    forEachNonTrailingComment(function(comment, description) {
      it("returns true for " + description, function() {
        ...
        expect(sourceMappingURL.existsIn("code" + comment.contents)).to.equal(
          true
        );
  ...
  describe(".removeFrom", function() {
    ...
    forEachNonTrailingComment(function(comment, description) {
      it("removes the comment for " + description, function() {
        ...
        expect(sourceMappingURL.removeFrom("code" + comment.contents)).to.equal(
          "code" + comment.solution
        );

        expect(sourceMappingURL.removeFrom(comment.contents)).to.equal(
          comment.solution
        );
      });
    });
  ...
  describe(".insertBefore", function() {
    forEachComment(function(comment, description) {
      it("inserts a string before the comment for " + description, function() {
        ...
        expect(
          sourceMappingURL.insertBefore("code" + comment, "\nmore code")
        ).to.equal("code\nmore code" + comment);

        expect(sourceMappingURL.insertBefore(comment, "some code")).to.equal(
          "some code" + comment
        );
      });
    });
    ...
    it("is detachable", function() {
      ...
      expect(insertBefore("/*# sourceMappingURL=foo */", "bar")).to.equal(
  ...
  describe(".regex", function() {
    it("includes ._innerRegex", function() {
      expect(sourceMappingURL.regex.source).to.contain(
  ...
  describe("._innerRegex", function() {
    it("matches the contents of sourceMappingURL comments", function() {
      expect(
        "# sourceMappingURL=http://www.example.com/foo/bar.js.map"
      ).to.match(sourceMappingURL._innerRegex);
    });

    it("captures the url in the first capture group", function() {
      expect(
        sourceMappingURL._innerRegex.exec("# sourceMappingURL=foo")[1]
      ).to.equal("foo");
    });
