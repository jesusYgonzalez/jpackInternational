...
var code = {
  ...
  dataUriParameter: u(
    "data:application/json;charset=UTF-8;foo=bar," +
      "%7B%22mappings%22%3A%22AAAA%22%2C%22sources%22%3A%5B%22" +
      "foo.js%22%5D%2C%22names%22%3A%5B%5D%7D"
  ),
...
function testResolveSourceMap(method, sync) {
  return function(t) {
    ...
    method(code.fileRelative, codeUrl, wrap(read(map.simpleString)), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.domainRelative, codeUrl, wrap(read(map.simpleString)), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.schemeRelative, codeUrl, wrap(read(map.simpleString)), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.absolute, codeUrl, wrap(read(map.simpleString)), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.dataUriParameter, codeUrl, wrap(Throws), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.dataUriInvalidMime, codeUrl, wrap(Throws), function(
      error,
      result
    ) {
      t.deepEqual(
    ...
    method(code.dataUriInvalidJSON, codeUrl, wrap(Throws), function(
      error,
      result
    ) {
      t.deepEqual(
      ...
      t.ok(
        error instanceof SyntaxError &&
          error.message !== "data:application/json,foo",
        "dataUriInvalidJSON"
      );
      t.notOk(result);
      isAsync();
    ...
    method(code.dataUriXSSIsafe, codeUrl, wrap(Throws), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.absolute, codeUrl, wrap(read("invalid JSON")), function(
      error,
      result
    ) {
      t.deepEqual(
    ...
    method(code.absolute, codeUrl, wrap(read(map.XSSIsafe)), function(
      error,
      result
    ) {
      t.error(error);
...
test(
  ".resolveSourceMap",
  testResolveSourceMap(sourceMapResolve.resolveSourceMap, false)
);

test(
  ".resolveSourceMapSync",
  testResolveSourceMap(sourceMapResolve.resolveSourceMapSync, true)
);
...
function testResolveSources(method, sync) {
  return function(t) {
    ...
    method(map.sourceRoot, mapUrl, wrap(identity), options, function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(map.sourceRootNoSlash, mapUrl, wrap(identity), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(map.sourceRootEmpty, mapUrl, wrap(identity), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(map.simple, mapUrl, wrap(read(["non", "string"])), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(map.mixed, mapUrl, wrap(Throws), function(error, result) {
      ...
      t.deepEqual(
        sourcesContent,
        ["foo.js", null, null, "/version.js", "//foo.org/baz.js"],
...
test(
  ".resolveSources",
  testResolveSources(sourceMapResolve.resolveSources, false)
);

test(
  ".resolveSourcesSync",
  testResolveSources(sourceMapResolve.resolveSourcesSync, true)
);
...
function testResolve(method, sync) {
  return function(t) {
    ...
    method(code.dataUri, codeUrl, wrapMap(Throws, identity), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.base64, codeUrl, wrapMap(Throws, identity), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.dataUriText, codeUrl, wrapMap(Throws, identity), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.dataUriParameter, codeUrl, wrapMap(Throws, identity), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.dataUriXSSIsafe, codeUrl, wrapMap(Throws, identity), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(
      code.absolute,
      codeUrl,
      wrapMap(read(map.XSSIsafe), identity),
    ...
    method(code.fileRelative, codeUrl, readMap(map.simple), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.fileRelative, codeUrl, readMap(map.sourceRoot), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.fileRelative, codeUrl, readMap(map.sourceRootNoSlash), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.fileRelative, codeUrl, readMap(map.sourceRootEmpty), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.fileRelative, codeUrl, readMap(map.sourcesContent), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.fileRelative, codeUrl, readMap(map.mixed), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.fileRelative, codeUrl, readMap(map.noSources), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.fileRelative, codeUrl, readMap(map.empty), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(code.fileRelative, codeUrl, ThrowsMap(map.mixed), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(null, mapUrl, wrap(read([map.simpleString])), function(
      error,
      result
    ) {
      t.error(error);
    ...
    method(null, mapUrl, wrapMap(read(map.XSSIsafe), identity), function(
      error,
      result
    ) {
      t.error(error);
    ...
    options = { sourceRoot: "/static/js/" };
    method(null, mapUrl, readMap(map.sourceRoot), options, function(
      error,
      result
    ) {
      t.error(error);
