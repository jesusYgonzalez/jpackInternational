  ...
  return {
    visitor: {
      ...
      Program: function Program(path) {
        if (
          path.get("body").some(function(child) {
...
if (program.eval || program.print) {
  ...
  if (program.print) {
    var output =
      typeof result === "string" ? result : (0, _util.inspect)(result);
  ...
  if (program.args.length) {
    ...
    var filename = args[0];
    if (!(0, _pathIsAbsolute2.default)(filename))
      args[0] = _path2.default.join(process.cwd(), filename);
