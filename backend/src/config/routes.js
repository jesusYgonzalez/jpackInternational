...
//
// // BAG ROUTES //
const antiStaticBags = require("../api/controllers/bagsController/AntiStaticBags.controller");
const clearPolyBags = require("../api/controllers/bagsController/clearPolyBags.controller");
const bubblePouches = require("../api/controllers/bagsController/bubblePouches.controller");
const reclosableBags = require("../api/controllers/bagsController/reclosableBags.controller");
const polypropyleneBags = require("../api/controllers/bagsController/polypropyleneBags.controller");
const polyTubing = require("../api/controllers/bagsController/polyTubing.controller");
const staticShieldingBags = require("../api/controllers/bagsController/staticShieldingBags.controller");
const vacuumBags = require("../api/controllers/bagsController/vacuumBags.controller");
const polyBagSealer = require("../api/controllers/bagsController/polyBagSealer.controller");
//
// // BOXES ROUTES //
